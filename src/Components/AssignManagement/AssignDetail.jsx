  ...
  return (
    <>
      <div className="header flex flex-wrap justify-center" id="topLoc">
        <div className="mx-5 assignmanagement_header rounded-xl shadow-md overflow-hidden md:px-20 sm:px-0 pt-5 pb-10 my-10 lg:w-2/3 md:w-5/6 sm:w-full xxs:w-full">
          <blockquote class="mt-5 text-6xl font-semibold italic text-center text-slate-900">
            <span class="mt-3 mb-10 before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-blue-900 relative inline-block xxs:text-2xl sm:text-4xl md:text-6xl">
          ...
          <div className="my-5 overflow-hidden">
            <table className="mb-5 mr-5 mt-6 border text-center min-w-full divide-y divide-gray-200">
              <tr className="sm:w-full">
                <th className="border border-slate-200 bg-gray-50 px-3 py-3 text-center xxs:text-base sm:text-xl font-bold text-gray-500 tracking-wider">
                  신청 번호
                </th>
      ...
      <div className="header flex flex-wrap justify-center">
        <div className="mx-5 bg-white rounded-xl shadow-md overflow-hidden lg:w-2/3 md:w-5/6 sm:w-full xxs:w-full">
      ...
      <div className="header flex flex-wrap justify-center">
        <div className="mx-5 assignmanagement_header rounded-xl shadow-md md:px-20 sm:px-0 pt-5 pb-10 my-10 lg:w-2/3 md:w-5/6 sm:w-full xxs:w-full">
          {/* <div className=" pt-6 mb-3"> */}
          <blockquote className="mt-5 text-6xl font-semibold italic text-center text-slate-900">
            <span className="mt-3 mb-10 before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-red-400 relative inline-block xxs:text-2xl sm:text-4xl md:text-6xl">
