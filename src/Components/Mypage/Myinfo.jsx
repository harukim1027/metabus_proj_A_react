  ...
  return (
    <>
      <div className="header flex flex-wrap justify-center" id="topLoc">
        <div className="mx-5 mypage_header rounded-xl shadow-md overflow-hidden sm:px-20 my-10 lg:w-2/3 md:w-5/6 sm:w-full xxs:w-full">
          <blockquote class="xs:mt-2 md:mt-5 xl:text-4xl lg:text-3xl md:text-2xl sm:text-xl xxs:text-xl mb-3 font-semibold italic text-center text-slate-900">
          ...
          <div className="mb-5 overflow-hidden">
            <table className="mb-5 mt-3 border text-center min-w-full divide-y divide-gray-200">
              <tr>
                <th className="xl:text-xl lg:text-xl md:text-m sm:text-m xxs:text-sm border border-slate-200 bg-gray-50 px-4 py-3 text-center  font-bold text-gray-500 uppercase tracking-wider">
                  이름
                </th>
                <td>{userData?.name}</td>
              </tr>
