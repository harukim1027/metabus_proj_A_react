  ...
  return (
    <>
      <div className="header flex flex-wrap justify-center" id="topLoc">
        <div className="mx-5 accounts_header rounded-xl shadow-md overflow-hidden sm:px-20 pt-5 pb-10 my-10  lg:w-2/3 md:w-5/6 sm:w-full xxs:w-full">
          <main className="" role="main">
              ...
              <div className="px-4 py-5 xxs:w-full sm:w-2/3">
                ...
                <blockquote class="font-semibold italic text-center text-slate-900">
                  <span class="before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-pink-500 relative inline-block">
                    <span class="xl:text-4xl lg:text-2xl md:text-xl sm:text-xl xxs:text-xl relative text-white">
                      " 약관 및 개인정보 처리방침 "
                    </span>
                  </span>
                  <p className="xl:text-4xl lg:text-2xl md:text-xl sm:text-xl xxs:text-xl mt-3 mb-3">
                    안내를 반드시 읽고, 동의해주세요 !
                  </p>
                </blockquote>
              </div>
            ...
            <div className="w-full">
              <div className="xl:text-xl lg:text-xl md:text-base sm:text-base xxs:text-sm sm:mt-0 sm:col-span-2">
                <div className="mx-5">
                  <p className="xl:text-xl lg:text-xl md:text-base sm:text-sm xxs:text-sm after:content-['*'] after:ml-0.5 after:text-red-500 block uppercase tracking-wide text-gray-700 font-bold mb-2">
                    회원 가입 약관 동의 [ 필수 ]
                  </p>

                  <SignupAgreementation />

                  <div className="xl:text-xl lg:text-xl md:text-base sm:text-sm xxs:text-sm sm:mt-0 sm:col-span-2 text-right pb-5 font-bold text-gray-700">
                ...
                <div className="mx-5">
                  ...
                  <div className="xl:text-xl lg:text-xl md:text-base sm:text-base xxs:text-sm sm:mt-0 sm:col-span-2 text-right pb-5 font-bold text-gray-700">
                ...
                <div className="mx-5 pb-3 text-right ">
                  <label className="xl:text-xl lg:text-xl md:text-base sm:text-base xxs:text-sm sm:mt-0 sm:col-span-2 bg-yellow-100 font-bold">
                    모두 동의합니다
                    <input
                ...
                <hr />
                <div className="xl:text-3xl lg:text-2xl md:text-xl sm:text-xl xxs:text-base sm:mt-0 sm:col-span-2 text-red-400 text-center">
                  <br />
